			...
			<div class="product" itemscope itemtype="https://schema.org/Product">
				...
				<div class="button-container">
					{if ($product.id_product_attribute == 0 || (isset($add_prod_display) && ($add_prod_display == 1))) && $product.available_for_order && !isset($restricted_country_mode) && $product.customizable != 2 && !$PS_CATALOG_MODE}
						...
						{/if}
					{/if}
					<a class="btn btn-rect" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='View'}">
						{if (isset($product.customization_required) && $product.customization_required)}{l s='Customize'}{else}{l s='More info'}{/if}
					</a>
					<a class="contact-us-popup btn btn-rect btn-dark" href="{$link->getPageLink('contact')}?content_only=1" title="{l s='Buy'}">
						{l s='Buy now'}
					</a>
				</div>
